...
FHEMDevice(platform, s) {
    ...
    if (s.Attributes.subType == 'VacuumCleaner') {
        ...
        this.mappings.Dock = {reading: 'state', cmd: 'charge'};
        this.mappings.Locate = {cmd: 'locate'};
        this.mappings.StartStop = {reading: 'state', cmdPause: 'pause', cmdUnpause: 'on', cmdOn: 'on', cmdOff: 'off'};
        //FIXME get FanSpeed names from cmd
        this.mappings.FanSpeed = {
            ...
            speed_attributes: {
              speeds: [{
                speed_name: 'quiet',
                speed_values: [{
                  speed_synonym: ['quiet', 'stufe 1', 'leise'],
                  lang: 'de'
                }]
              },
              {
                speed_name: 'balanced',
                speed_values: [{
                  speed_synonyms: ['balanced', 'stufe 2', 'normal'],
                  lang: 'de'
                }]
              },
              {
              ...
              },
              {
                speed_name: 'max',
                speed_values: [{
                  speed_synonyms: ['max', 'stufe 4', 'maximum'],
                  lang: 'de'
                }]
              }],
              ordered: true
