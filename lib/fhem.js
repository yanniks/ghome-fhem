...
FHEMDevice(platform, s) {
    ...
    if (s.Internals.TYPE === 'MilightDevice'
        ...
        this.mappings.Brightness = {reading: 'brightness', cmd: 'dim', max: 100, maxValue: 1, delay: true};
        ...
        this.mappings.Brightness = {reading: 'brightness', cmd: 'HSV', max: 100, maxValue: 1, delay: true};
    ...
    if (!this.mappings.Hue || s.Internals.TYPE === 'SWAP_0000002200000003') {
        ...
        if (reading && cmd) {
            ...
            this.mappings.Brightness = {reading: reading, cmd: cmd, max: 100, maxValue: 1, delay: true};
